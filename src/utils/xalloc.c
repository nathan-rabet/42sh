...
{
    void *data = to_data(temp, sizeof(struct xalloc_item));
    temp->data = data;
    temp->next = NULL;
...
void xfree(void *ptr)
{
    ...
    struct xalloc_item *temp = to_data(ptr, -sizeof(struct xalloc_item));
